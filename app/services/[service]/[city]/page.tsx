...
export default function ServiceCityPage({ params }: { params: { service: string; city: string } }) {
  ...
  const benefits = [
    { icon: <Award className="w-6 h-6" />, title: 'Implant Specialists', desc: 'Only the top 1% of UK Dental Implants specialists' },
      ...
      <div className="relative overflow-hidden pt-24 pb-16 sm:pt-28 sm:pb-20 md:pt-32 md:pb-24 min-h-[640px] sm:min-h-[680px] md:min-h-[720px]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 space-y-16">
          <div className="flex flex-wrap items-center gap-2 text-sm text-slate-400">
            ...
            <span>/</span>
            <Link href={`/services/${params.service}`} className="hover:text-emerald-400 transition-colors">
              {service.title}
            </Link>
            <span>/</span>
          ...
          <div className="text-center space-y-8">
            ...
            <p className="text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed font-medium">
              {service.desc} Connect with {cityName}&apos;s most experienced Platinum-tier Dental Implants specialists.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
              <button
                onClick={() => setIsModalOpen(true)}
                className="px-10 py-5 bg-emerald-500 text-white font-black rounded-full shadow-2xl hover:scale-105 transition-all text-lg"
              >
              ...
              <Link
                ...
                className="px-10 py-5 bg-white/5 text-white font-bold rounded-full border border-white/10 hover:border-emerald-500/30 transition-all text-lg backdrop-blur-sm"
              >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="dark-card p-10 rounded-[2.5rem] border border-white/5">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-1" />
                  <p className="text-slate-300">State-of-the-art 3D scanning and 3D treatment planning visualization technology</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-emerald-400 flex-shrink-0 mt-1" />
