      ...
      >
        ...
        <div className="p-8 md:p-12">
          {isSuccess ? (
            ...
            <>
              <div className="mb-8">
                <div className="inline-block px-3 py-1 bg-emerald-50 text-emerald-600 text-[10px] font-black uppercase tracking-widest rounded-full mb-3 shadow-sm shadow-emerald-100">
                  Priority Referral
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-1.5 group">
                  <label className="text-xs font-bold text-slate-500 uppercase tracking-wider ml-1 group-focus-within:text-emerald-500 transition-colors">Full Name</label>
                  <input 
                    required 
                    type="text" 
                ...
                <div className="space-y-1.5 group">
                  <label className="text-xs font-bold text-slate-500 uppercase tracking-wider ml-1 group-focus-within:text-emerald-500 transition-colors">Email Address</label>
                  <input 
                    required 
                    type="email" 
                    className="w-full px-5 py-4 bg-slate-50 rounded-2xl border-2 border-slate-100 text-slate-700 focus:border-emerald-400 focus:bg-white focus:ring-8 focus:ring-emerald-400/5 outline-none transition-all placeholder:text-slate-300" 
                ...
                <div className="space-y-1.5 group">
                  <label className="text-xs font-bold text-slate-500 uppercase tracking-wider ml-1 group-focus-within:text-emerald-500 transition-colors">Your City / Location</label>
                  <input 
                    required 
                    type="text" 
                    className="w-full px-5 py-4 bg-slate-50 rounded-2xl border-2 border-slate-100 text-slate-700 focus:border-emerald-400 focus:bg-white focus:ring-8 focus:ring-emerald-400/5 outline-none transition-all placeholder:text-slate-300" 
                ...
                <button 
                  ...
                  type="submit" 
                  className="w-full py-5 mt-4 bg-emerald-500 hover:bg-emerald-600 text-white font-black text-lg rounded-2xl shadow-xl shadow-emerald-500/20 transition-all active:scale-[0.98] flex items-center justify-center gap-3 relative overflow-hidden group/btn"
                >
